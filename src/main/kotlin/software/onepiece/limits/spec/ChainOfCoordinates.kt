...
data class ChainOfCoordinates(val projectName: String, val typeName: String, val pointsAt: Spec, val components: List<CoordinatesSpec> = emptyList()) : Serializable, TypeSpec {
